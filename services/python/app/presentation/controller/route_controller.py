...
async def create_route(body: CreateRouteRequest, service: RouteService = Depends(get_route_service)):
    r = await service.create_route(CreateRouteDTO(**body.model_dump()))
